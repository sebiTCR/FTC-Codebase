...
@Config
@TeleOp(group = "Final")
public class TeleOpFinalDS extends LinearOpMode {
...
//    Claw claw;
    ...
    SimpleServo ClawC1;
    SimpleServo ClawC2;
//    int bossId = hardwareMap.appContext.getResources().getIdentifier("boss", "raw", hardwareMap.appContext.getPackageName());
...
//    GamepadButton claw_grab_btn = new GamepadButton(gamepad2, GamepadKeys.Button.A);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        SoundPlayer.getInstance().preload(hardwareMap.appContext, new File("boss.mp3"));
...
//        GamepadButton grab_btn = new GamepadButton(gamepad2, GamepadKeys.Button.A);
        ...
        SoundPlayer.getInstance().startPlaying(hardwareMap.appContext, new File("boss.mp3"));
        ...
        while (opModeIsActive()){
            ...
            if(gamepad1.left_stick_y != 0 || gamepad1.right_stick_y != 0){
                chassis.Move((float) (gamepad1.left_stick_y) , (float) (gamepad1.right_stick_y));
            }
