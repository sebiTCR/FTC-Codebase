...
public class DetectionPipeline_matei extends OpenCvPipeline {
    ...
    public double[] getRGBArrayFromZone(int zone)
    {
        double r = getZoneRGB(zone,0);
        double g = getZoneRGB(zone,1);
        double b = getZoneRGB(zone,2);
